...
const CartPage = () => {
    ...
    const handlePayment = async () => {
        ...
        try{
            ...
            const res = await fetch(`https://onestmern-ecommerce-12.onrender.com/braintree/payment`, {
                method: "POST",
                headers: {
    ...
    const getToken = async () => {
        try {
            const res = await fetch('https://onestmern-ecommerce-12.onrender.com/braintree/token');
            const data = await res.json()
