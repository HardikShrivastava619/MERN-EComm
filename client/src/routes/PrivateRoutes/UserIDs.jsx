...
async function getUser() {
    try {
        const res = await fetch (`https://onestmern-ecommerce-11.onrender.com/get-User/${params.id}`)
...
const getOrders = async ()=>{
    try {
    const res =  await fetch(`https://onestmern-ecommerce-11.onrender.com/orders/${params.id}` , {
    })
    const data = await res.json()
