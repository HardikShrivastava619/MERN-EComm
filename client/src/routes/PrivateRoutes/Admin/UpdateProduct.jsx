...
//===================>
  async function handleUpdate(e) {
    ...
    try {
      ...
      const res = await fetch(`https://onestmern-ecommerce-12.onrender.com/update-product/${id}`, {
        method: "PUT",
        headers: {    
...
//===================>
 ...
 async function handleDelete() {
  try {
    ...
    const res = await fetch(`https://onestmern-ecommerce-12.onrender.com/delete-product/${id}` ,  {
  method:'DELETE',
})
const data = await res.json()
...
<img   src={`https://onestmern-ecommerce-12.onrender.com/product-photo/${id}`}   alt="error_in_Loading "  height="200" className="img img-responsive"   />    </div>)
