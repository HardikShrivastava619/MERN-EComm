...
async function handleSubmit (e) {
  ...
  try {
    ...
    const response = await fetch("https://mern-ecomm-62pn.onrender.com/create-category", {
      method: "POST",
      headers: {
...
async function handleUpdate(e) {
  ...
  try {
    ...
    const res = await fetch(`https://mern-ecomm-62pn.onrender.com/update-category/${selected}`  , {
      method:"PUT",
      headers:{
        "Content-Type" : "application/json",
        "Authorization": `Bearer ${token}`
...
async function handleDelete(pId) {
  ...
  try {
    ...
    const res = await fetch(`https://mern-ecomm-62pn.onrender.com/delete-category/${pId}`  , {
      method:"DELETE",
