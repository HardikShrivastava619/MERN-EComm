...
const AdminOrder = () => {
    ...
    const getOrders = async ()=>{
      try {
      const res =  await fetch(`https://onestmern-ecommerce-12.onrender.com/orders` , {
        headers:{
...
const handleChange = async (orderId , v)=>{
    try{
        const res = await fetch(`https://onestmern-ecommerce-12.onrender.com/orders-staus/${orderId}` , {
method:"PUT",
headers:{
